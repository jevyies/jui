 ...
 * 2. Default Active Theme (dark, light, solarized, cyberpunk, system)
...
export const themeConfig = {
  ...
  // - 'dark'      : Midnight zinc & violet
  // - 'light'     : Clean slate & indigo
  // - 'solarized' : Warm cyan & retro base
  ...
  //   defaultModalStyle: {
  //     dark: 'glass',      // Modal style for dark mode (and solarized/cyberpunk if unassigned)
  //     light: 'elevated',  // Modal style for light mode
  //     solarized: 'tonal', // (optional) for solarized theme
  //     cyberpunk: 'bordered', // (optional) for cyberpunk theme
  //   },
