...
const isDrawer = computed(() => {
  ...
  return p.startsWith('drawer') || p === 'bottom-sheet'
})
...
const positionClass = computed(() => {
  if (isDrawer.value) {
    return `modal-drawer modal-drawer-${drawerSide.value}`
  }
...
<template>
  <Teleport to="body">
    <div v-if="modelValue">
      ...
      <!-- Modal Container -->
      <div :class="['modal', positionClass, sizeClass]" role="dialog" aria-modal="true"
        @click.self="handleBackdropClick">
        <div :class="['modal-dialog', animationClass, sizeClass]">
          <div :class="['modal-content', contentVariantClass, scrollable ? 'modal-scrollable' : '']">
            <!-- Header -->
